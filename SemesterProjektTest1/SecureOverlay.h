...
#define AFX_SECUREOVERLAY_H__44323373_9E89_11D3_A393_00C0DFC59237__INCLUDED_
...
class CSecureOverlay : public CWindowImpl<CSecureOverlay>
{
public:
	...
	virtual ~CSecureOverlay()
	{
	};

	BEGIN_MSG_MAP(CSecureOverlay)
