================================================================================
    MICROSOFT FOUNDATION CLASS-BIBLIOTHEK: SemesterProjektTest1-Projektübersicht
===============================================================================

Diese SemesterProjektTest1-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt. Diese Anwendung zeigt nicht nur die Grundlagen der Verwendung von Microsoft Foundation Classes, sondern dient auch als Ausgangspunkt für das Schreiben Ihrer Anwendung.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre SemesterProjektTest1-Anwendung besteht.

SemesterProjektTest1.vcxproj
...
SemesterProjektTest1.vcxproj.filters
...
SemesterProjektTest1.h
    Dies ist die Hauptheaderdatei für die Anwendung.
    Sie enthält andere projektspezifische Header (einschließlich Resource.h) und deklariert die CSemesterProjektTest1App-Anwendungsklasse.

SemesterProjektTest1.cpp
    Dies ist die wichtigste Anwendungsquelldatei, die die Anwendungsklasse CSemesterProjektTest1App enthält.

SemesterProjektTest1.rc
...
res\SemesterProjektTest1.ico
    Dies ist eine Symboldatei, die als Anwendungssymbol verwendet wird. Dieses Symbol ist in der Hauptressourcendatei SemesterProjektTest1.rc enthalten.

res\SemesterProjektTest1.rc2
...
SemesterProjektTest1Dlg.h, SemesterProjektTest1Dlg.cpp - das Dialogfeld
    Diese Dateien enthalten Ihre CSemesterProjektTest1Dlg-Klasse. Diese Klasse definiert das Verhalten des Hauptdialogfelds der Anwendung. Die Vorlage für das Dialogfeld befindet sich in SemesterProjektTest1.rc und kann in Microsoft Visual C++ bearbeitet werden.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen SemesterProjektTest1.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
